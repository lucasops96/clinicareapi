...
class CustomUser(models.Model):
    user = models.OneToOneField(User,on_delete=models.PROTECT ,related_name='user_custom',null=True)
...
class ProfissionalSaude(models.Model):
    ...
    enderecos_atendimento = models.ManyToManyField(Endereco,related_name='profissionais_atendimento')
